    ...
    <SafeAreaProvider>
      <SafeAreaView style={loginStyles.container}>
        ...
        <View style={loginStyles.loginInputContainer}>
          ...
          <Pressable style={loginStyles.continueParent} onPress={() => {
...
<Text style={[loginStyles.bySigningUp, loginStyles.textTypo]}>{`By signing up, you agree to the `}</Text>
<Text style={loginStyles.termsOfService}>
<Text style={loginStyles.termsOfService1Typo}>Terms of Service</Text>
<Text style={loginStyles.textTypo}>{` `}</Text>
</Text>
<Text style={loginStyles.textTypo}>
<Text style={loginStyles.and1}>{`and `}</Text>
</Text>
<Text style={[loginStyles.dataProcessingAgreement, loginStyles.termsOfService1Typo]}>Data Processing Agreement</Text>
</Text>
</Text>
        </View>
      </SafeAreaView>
